...
class MirrorStatus:
    STATUS_UPLOADING = "Uploading Bruh"
    STATUS_DOWNLOADING = "Downloading Bruh"
    STATUS_WAITING = "Queued"
    STATUS_FAILED = "Failed. Cleaning download"
    STATUS_CANCELLED = "Ok Cancelled"
    STATUS_ARCHIVING = "Archiving Bruh"
    STATUS_EXTRACTING = "Extracting Bruh"
