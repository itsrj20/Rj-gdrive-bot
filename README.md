...
This is a telegram bot writen in python for Mirroring files to gdrive. contact @itsrj20 @IndianRedmiK20pro
...
- Clone this repo:
```
git clone https://github.com/itsrj20/Rj-gdrive-bot/
cd mirror-bot
```
