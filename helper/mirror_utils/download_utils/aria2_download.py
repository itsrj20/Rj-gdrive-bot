...
class AriaDownloadHelper(DownloadHelper):
    ...
    def __onDownloadStarted(self, api, gid):
        ...
        if STOP_DUPLICATE_MIRROR:
            if smsg:
                dl.getListener().onDownloadError(f'😡😡<code> Wait wait wait File is already available in drive. You should have search before mirror any file.</code> <b>You might get ban next time so keep your eyes open.</b> <code>Stopping this download now.</code>\n\n Here are the search results:👇👇 \n\n{smsg}')
